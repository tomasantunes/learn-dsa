...
router.get('/pt/trees', function(req, res, next) {
  res.render('content/pt/trees');
});

router.get('/pt/binary-trees', function(req, res, next) {
  res.render('content/pt/binary-trees');
});

router.get('/pt/binary-search-trees', function(req, res, next) {
...
router.get('/pt/red-black-tree', function(req, res, next) {
  res.render('content/pt/red-black-tree');
});

router.get('/pt/pre-order-traversal', function(req, res, next) {
...
router.get('/pt/post-order-traversal', function(req, res, next) {
  res.render('content/pt/post-order-traversal');
});
